<template>
    <div class="font-serif mt-5 mb-32 lg:bg-zinc-500 bg-zinc-500">
      <h1 class="text-center lg:text-center lg:mt-10 lg:text-xl lg:font-bold lg:text-blue-900 font-bold">Todo List</h1>
      <div class="lg:bg-zinc-200 lg:shadow-md lg:rounded-lg lg:mt-4 lg:mr-96 lg:ml-96 text-center justify-center align-middle lg:pl-32 lg:py-20 mr-5 ml-4 shadow-md">
        <div class="lg:flex lg:mb-4 mb-2 ">
          ...
          <button @click="addText"
            class="bg-cyan-800 lg:rounded-md lg:text-black lg:px-4 lg:-mt-2 lg:ml-4 text-black rounded-md py-2 px-12 ml-2 mb-4 lg:bg-cyan-800 border-2 border-cyan-900">Add Task</button>
        </div>
        <div>
